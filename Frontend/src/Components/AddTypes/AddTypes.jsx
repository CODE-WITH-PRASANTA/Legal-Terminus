      ...
      <div className="Add-typestypes-container">
        ...
        <div className="Add-typestypes-content">
          ...
          <div className="Add-typestypes-block">
            <h3 className="Add-typestypes-subtitle">Company limited by Shares</h3>
          ...
          {/* Type 2 */}
          <div className="Add-typestypes-block">
            <h3 className="Add-typestypes-subtitle">Company limited by Guarantee</h3>
            <p className="Add-typestypes-text">
          ...
          {/* Type 3 */}
          <div className="Add-typestypes-block">
            <h3 className="Add-typestypes-subtitle">Unlimited Companies</h3>
            <p className="Add-typestypes-text">
