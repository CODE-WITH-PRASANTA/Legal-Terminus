...
const GoogleTestimonials = () => {
  ...
  const handleScroll = (direction) => {
    ...
    const card = container.querySelector(".lt-card");
    if (!card) return;
  ...
  return (
    <section className="lt-section">
      <div className="lt-container">
        ...
        <div className="lt-slider-wrapper">
          {/* Left arrow */}
          <button
            className="lt-side-arrow lt-left"
          ...
          {/* Cards slider */}
          <div className="lt-slider" ref={sliderRef}>
            {testimonials.map((t, idx) => (
              <article className="lt-card" key={idx}>
                {/* top quote */}
                <span className="lt-quote lt-quote-top">“</span>
                ...
                {/* text */}
                <p className="lt-text">{t.text}</p>

                {/* name & role */}
                <h3 className="lt-name">{t.name}</h3>
                <p className="lt-role">{t.role}</p>
                ...
                {/* bottom quote */}
                <span className="lt-quote lt-quote-bottom">”</span>
              </article>
            ))}
          </div>
          ...
          {/* Right arrow */}
          <button
            className="lt-side-arrow lt-right"
