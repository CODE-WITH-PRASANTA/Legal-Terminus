  ...
  return (
    <section className="trust-root">
      <div className="trust-container">
        <h2 className="trust-title">OUR CLIENTS</h2>

        <div className="trust-carousel">
          <button className="trust-arrow trust-arrow-left"
          ...
          <div className="trust-scroller">
            <ul className="trust-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="trust-card" key={i}>
                  <figure className="trust-logo">
                    <img src={src} alt={`client-${i}`} className="trust-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="trust-arrow trust-arrow-right"
