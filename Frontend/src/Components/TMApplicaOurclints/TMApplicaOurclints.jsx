...
const OurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".Tm-Applica-clients-card");
  ...
  return (
    <section className="Tm-Applica-clients-root">
      <div className="Tm-Applica-clients-container">
        <h2 className="Tm-Applica-clients-title">OUR CLIENTS</h2>

        <div className="Tm-Applica-clients-carousel">
          <button className="Tm-Applica-clients-arrow Tm-Applica-clients-arrow-left"
          ...
          <div className="Tm-Applica-clients-scroller">
            <ul className="Tm-Applica-clients-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="Tm-Applica-clients-card" key={i}>
                  <figure className="Tm-Applica-clients-logo">
                    <img src={src} alt={`client-${i}`} className="Tm-Applica-clients-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="Tm-Applica-clients-arrow Tm-Applica-clients-arrow-right"
