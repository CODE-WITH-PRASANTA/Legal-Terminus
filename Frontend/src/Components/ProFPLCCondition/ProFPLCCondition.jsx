...
import "./ProFPLCCondition.css";

const TermsConditions = () => {
  return (
    <section className="profplc-tc-section">
      <div className="profplc-tc-container">
        {/* Heading */}
        <h2 className="profplc-tc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="profplc-tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="profplc-tc-list">
          <li className="profplc-tc-item">
