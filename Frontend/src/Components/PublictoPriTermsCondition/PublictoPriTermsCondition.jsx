...
import "./PublictoPriTermsCondition.css";

const TermsConditions = () => {
  return (
    <section className="pvt-pub-tc-section">
      <div className="pvt-pub-tc-container">
        {/* Heading */}
        <h2 className="pvt-pub-tc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="pvt-pub-tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="pvt-pub-tc-list">
          <li className="pvt-pub-tc-item">
