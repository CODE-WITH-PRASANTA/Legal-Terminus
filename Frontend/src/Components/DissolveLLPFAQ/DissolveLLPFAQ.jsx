...
const DissolveLLPFAQ = () => {
  ...
  return (
    <section className="Diss-llp-faq-section">
      <div className="Diss-llp-faq-container">
        {/* Left side – static text */}
        <div className="Diss-llp-faq-left">
          <h2 className="Diss-llp-faq-title">Private Limited Company Registration FAQ&apos;s</h2>

          <p className="Diss-llp-faq-intro">
