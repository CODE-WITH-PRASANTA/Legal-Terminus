...
import "./LlptoPriTermandcondn.css";

const TermsConditions = () => {
  return (
    <section className="LLP-to-PLC-tc-section">
      <div className="LLP-to-PLC-tc-container">
        {/* Heading */}
        <h2 className="LLP-to-PLC-tc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="LLP-to-PLC-tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="LLP-to-PLC-tc-list">
          <li className="LLP-to-PLC-tc-item">
