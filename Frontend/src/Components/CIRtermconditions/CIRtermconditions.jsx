...
import "./CIRtermconditions.css";

const TermsConditions = () => {
  return (
    <section className="cir-tc-section">
      <div className="cir-tc-container">
        {/* Heading */}
        <h2 className="cir-tc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="cir-tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="cir-tc-list">
          <li className="cir-tc-item">
