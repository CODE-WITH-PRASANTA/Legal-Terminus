...
import "./TMTermandCondition.css";

const TermsConditions = () => {
  return (
    <section className="Tm--tc-section">
      <div className="Tm--tc-container">
        {/* Heading */}
        <h2 className="Tm--tc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="Tm--tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="Tm--tc-list">
          <li className="Tm--tc-item">
