...
import "./TrademarktoHearingTermCondition.css";

const TradeLicenseTermCondition = () => {
  return (
    <section className="thtc-section">
      <div className="thtc-container">
        {/* Heading */}
        <h2 className="thtc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="thtc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="thtc-list">
          <li className="thtc-item">
