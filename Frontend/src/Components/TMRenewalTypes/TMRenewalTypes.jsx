...
import "./TMRenewalTypes.css";
import typesIllustration from "../../assets/pvtltd-types.png"


const PvtTypes = () => {
  return (
    <section className="Tm-types-section">
      <div className="Tm-types-container">
        {/* Left graphic */}
        <div className="Tm-types-illustration-wrap">
          <img
            src={typesIllustration}
            alt="Types of Private Limited Company"
            className="Tm-types-illustration"
          />
        </div>

        {/* Right content */}
        <div className="Tm-types-content">
          <h2 className="Tm-types-title">
            Types of Proprietorship Firms Registration
          </h2>

          {/* <p className="Tm-types-intro">
          ...
          {/* Type 1 */}
          <div className="Tm-types-block">
            <h3 className="Tm-types-subtitle">Company limited by Shares</h3>
            <p className="Tm-types-text">
          ...
          {/* Type 2 */}
          <div className="Tm-types-block">
            <h3 className="Tm-types-subtitle">Company limited by Guarantee</h3>
            <p className="Tm-types-text">
          ...
          {/* Type 3 */}
          <div className="Tm-types-block">
            <h3 className="Tm-types-subtitle">Unlimited Companies</h3>
            <p className="Tm-types-text">
