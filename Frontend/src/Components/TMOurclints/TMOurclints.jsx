...
const OurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".Tm-clients-card");
  ...
  return (
    <section className="Tm-clients-root">
      <div className="Tm-clients-container">
        <h2 className="Tm-clients-title">OUR CLIENTS</h2>

        <div className="Tm-clients-carousel">
          <button className="Tm-clients-arrow Tm-clients-arrow-left"
          ...
          <div className="Tm-clients-scroller">
            <ul className="Tm-clients-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="Tm-clients-card" key={i}>
                  <figure className="Tm-clients-logo">
                    <img src={src} alt={`client-${i}`} className="Tm-clients-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="Tm-clients-arrow Tm-clients-arrow-right"
