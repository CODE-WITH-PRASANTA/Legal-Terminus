      ...
      <div className="Increase-public-container">
        ...
        <div className="Increase-public-content">
          ...
          <div className="Increase-public-features">
            <div className="Increase-feature-item"> Minimum 2 Directors Required</div>
            <div className="Increase-feature-item"> Separate Legal Entity</div>
            <div className="Increase-feature-item"> Limited Liability Protection</div>
            <div className="Increase-feature-item"> High Business Credibility</div>
          </div>
