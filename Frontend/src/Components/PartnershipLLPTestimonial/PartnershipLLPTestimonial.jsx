...
import "./PartnershipLLPTestimonial.css";
...
const PartnershipLLPTestimonial = () => {
  ...
  const handleScroll = (direction) => {
    ...
    const card = container.querySelector(".partnership-llp-testimonial-card");
    if (!card) return;
  ...
  return (
    <section className="partnership-llp-testimonial-section">
      <div className="partnership-llp-testimonial-container">
        <h2 className="partnership-llp-testimonial-heading">
          See What Our Customers Say on Google
        </h2>

        <div className="partnership-llp-testimonial-slider-wrapper">
          <button
            className="partnership-llp-testimonial-arrow partnership-llp-testimonial-left"
          ...
          <div
            className="partnership-llp-testimonial-slider"
            ref={sliderRef}
          >
            {testimonials.map((t, idx) => (
              <article
                className="partnership-llp-testimonial-card"
                key={idx}
              >
                <span className="partnership-llp-testimonial-quote partnership-llp-testimonial-quote-top">
                  “
                </span>

                <div className="partnership-llp-testimonial-avatar-wrap">
                  <div className="partnership-llp-testimonial-avatar">
                    <span>{t.initial}</span>
                  </div>
                </div>

                <p className="partnership-llp-testimonial-text">{t.text}</p>

                <h3 className="partnership-llp-testimonial-name">{t.name}</h3>
                <p className="partnership-llp-testimonial-role">{t.role}</p>

                <div className="partnership-llp-testimonial-stars">
                  {Array.from({ length: t.rating }).map((_, i) => (
                    <span key={i}>★</span>
                  ))}
                </div>

                <span className="partnership-llp-testimonial-quote partnership-llp-testimonial-quote-bottom">
                  ”
                </span>
              </article>
            ))}
          ...
          <button
            className="partnership-llp-testimonial-arrow partnership-llp-testimonial-right"
...
export default PartnershipLLPTestimonial;
