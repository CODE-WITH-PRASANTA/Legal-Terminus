...
import "./PartnershipLLPOurclints.css";
...
const OurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".partnership-llp--partnership-llp--clients-card");
  ...
  return (
    <section className="partnership-llp--clients-root">
      <div className="partnership-llp--clients-container">
        <h2 className="partnership-llp--clients-title">OUR CLIENTS</h2>

        <div className="partnership-llp--clients-carousel">
          <button className="partnership-llp--clients-arrow partnership-llp--clients-arrow-left"
          ...
          <div className="partnership-llp--clients-scroller">
            <ul className="partnership-llp--clients-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="partnership-llp--clients-card" key={i}>
                  <figure className="partnership-llp--clients-logo">
                    <img src={src} alt={`client-${i}`} className="partnership-llp--clients-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="partnership-llp--clients-arrow partnership-llp--clients-arrow-right"
