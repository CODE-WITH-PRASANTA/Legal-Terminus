...
const IncorporationOurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".incorp-our-clients-card");
  ...
  return (
    <section className="incorp-our-clients-root">
      <div className="incorp-our-clients-container">
        <h2 className="incorp-our-clients-title">OUR CLIENTS</h2>

        <div className="incorp-our-clients-carousel">
          <button
            className="incorp-our-clients-arrow incorp-our-clients-arrow-left"
            onClick={() => scrollByCard("left")}
          >
            ❮
          </button>

          <div className="incorp-our-clients-scroller">
            <ul
              className="incorp-our-clients-track"
              ref={trackRef}
            >
              {logosDup.map((src, i) => (
                <li
                ...
                >
                  <figure className="incorp-our-clients-logo">
                    <img
                      src={src}
                      alt={`client-${i}`}
                      className="incorp-our-clients-img"
                    />
                  </figure>
                </li>
              ))}
          ...
          <button
            className="incorp-our-clients-arrow incorp-our-clients-arrow-right"
...
export default IncorporationOurClients;
