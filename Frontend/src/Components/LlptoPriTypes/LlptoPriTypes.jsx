...
import "./LlptoPriTypes.css";
import typesIllustration from "../../assets/pvtltd-types.png"


const LlpTypes = () => {
  return (
    <section className="LLP-to-PLC-overview-types-section">
      <div className="LLP-to-PLC-overview-types-container">
        {/* Left graphic */}
        <div className="LLP-to-PLC-overview-types-illustration-wrap">
          <img
            src={typesIllustration}
            alt="Types of Limited Liability Partnership"
            className="LLP-to-PLC-overview-types-illustration"
          />
        </div>

        {/* Right content */}
        <div className="LLP-to-PLC-overview-types-content">
          <h2 className="LLP-to-PLC-overview-types-title">
            Types of Limited Liability Partnership
          </h2>

          <p className="LLP-to-PLC-overview-types-intro">
          ...
          {/* Type 1 */}
          <div className="LLP-to-PLC-overview-types-block">
            <h3 className="LLP-to-PLC-overview-types-subtitle">Company limited by Shares</h3>
            <p className="LLP-to-PLC-overview-types-text">
          ...
          {/* Type 2 */}
          <div className="LLP-to-PLC-overview-types-block">
            <h3 className="LLP-to-PLC-overview-types-subtitle">Company limited by Guarantee</h3>
            <p className="LLP-to-PLC-overview-types-text">
          ...
          {/* Type 3 */}
          <div className="LLP-to-PLC-overview-types-block">
            <h3 className="LLP-to-PLC-overview-types-subtitle">Unlimited Companies</h3>
            <p className="LLP-to-PLC-overview-types-text">
