...
import "./ReplyOfERTestimonial.css";
...
const GoogleTestimonials = () => {
  ...
  const handleScroll = (direction) => {
    ...
    const card = container.querySelector(".Rf-ER-gt-card");
    if (!card) return;
  ...
  return (
    <section className="Rf-ER-gt-section">
      <div className="Rf-ER-gt-container">
        <h2 className="Rf-ER-gt-heading">
          See What Our Customers Say on Google
        </h2>

        <div className="Rf-ER-gt-slider-wrapper">
          {/* Left arrow */}
          <button
            className="Rf-ER-gt-side-arrow Rf-ER-gt-left"
          ...
          {/* Cards slider */}
          <div className="Rf-ER-gt-slider" ref={sliderRef}>
            {testimonials.map((t, idx) => (
              <article className="Rf-ER-gt-card" key={idx}>
                {/* top quote */}
                <span className="Rf-ER-gt-quote Rf-ER-gt-quote-top">“</span>

                {/* avatar */}
                <div className="Rf-ER-gt-avatar-wrap">
                  <div className="Rf-ER-gt-avatar">
                    <span>{t.initial}</span>
                  </div>
                </div>

                {/* text */}
                <p className="Rf-ER-gt-text">{t.text}</p>

                {/* name & role */}
                <h3 className="Rf-ER-gt-name">{t.name}</h3>
                <p className="Rf-ER-gt-role">{t.role}</p>

                {/* stars */}
                <div className="Rf-ER-gt-stars">
                ...
                {/* bottom quote */}
                <span className="Rf-ER-gt-quote Rf-ER-gt-quote-bottom">”</span>
              </article>
            ))}
          </div>
          ...
          {/* Right arrow */}
          <button
            className="Rf-ER-gt-side-arrow Rf-ER-gt-right"
