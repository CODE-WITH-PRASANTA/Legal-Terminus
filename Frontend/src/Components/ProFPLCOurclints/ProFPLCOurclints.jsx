...
const OurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".ProFplc-ProFplc-clients-card");
  ...
  return (
    <section className="ProFplc-clients-root">
      <div className="ProFplc-clients-container">
        <h2 className="ProFplc-clients-title">OUR CLIENTS</h2>

        <div className="ProFplc-clients-carousel">
          <button className="ProFplc-clients-arrow ProFplc-clients-arrow-left"
          ...
          <div className="ProFplc-clients-scroller">
            <ul className="ProFplc-clients-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="ProFplc-clients-card" key={i}>
                  <figure className="ProFplc-clients-logo">
                    <img src={src} alt={`client-${i}`} className="ProFplc-clients-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="ProFplc-clients-arrow ProFplc-clients-arrow-right"
