      ...
      <div className="ChangeLlp-types-container">
        ...
        <div className="ChangeLlp-types-content">
          ...
          <div className="ChangeLlp-types-block">
            <h3 className="ChangeLlp-types-subtitle">Company limited by Shares</h3>
          ...
          {/* Type 2 */}
          <div className="ChangeLlp-types-block">
            <h3 className="ChangeLlp-types-subtitle">Company limited by Guarantee</h3>
            <p className="ChangeLlp-types-text">
          ...
          {/* Type 3 */}
          <div className="ChangeLlp-types-block">
            <h3 className="ChangeLlp-types-subtitle">Unlimited Companies</h3>
            <p className="ChangeLlp-types-text">
