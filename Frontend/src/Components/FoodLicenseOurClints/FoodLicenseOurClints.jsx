...
const FoodLicenseOurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    if (!track) return;
    const scroller = track.parentElement;
    const card = track.querySelector(".foodourclients-card");
  ...
  return (
    <section className="foodourclients-root">
      <div className="foodourclients-container">
        <h2 className="foodourclients-title">OUR CLIENTS</h2>

        <div className="foodourclients-carousel">
          <button
            className="foodourclients-arrow foodourclients-arrow-left"
          ...
          <button
            className="foodourclients-arrow foodourclients-arrow-right"
...
export default FoodLicenseOurClients;
