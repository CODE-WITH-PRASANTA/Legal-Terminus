...
import "./TMApplicaTestimonial.css";
...
const GoogleTestimonials = () => {
  ...
  const handleScroll = (direction) => {
    ...
    const card = container.querySelector(".Tm-Applica-gt-card");
    if (!card) return;
  ...
  return (
    <section className="Tm-Applica-gt-section">
      <div className="Tm-Applica-gt-container">
        <h2 className="Tm-Applica-gt-heading">
          See What Our Customers Say on Google
        </h2>

        <div className="Tm-Applica-gt-slider-wrapper">
          {/* Left arrow */}
          <button
            className="Tm-Applica-gt-side-arrow Tm-Applica-gt-left"
          ...
          {/* Cards slider */}
          <div className="Tm-Applica-gt-slider" ref={sliderRef}>
            {testimonials.map((t, idx) => (
              <article className="Tm-Applica-gt-card" key={idx}>
                {/* top quote */}
                <span className="Tm-Applica-gt-quote Tm-Applica-gt-quote-top">“</span>

                {/* avatar */}
                <div className="Tm-Applica-gt-avatar-wrap">
                  <div className="Tm-Applica-gt-avatar">
                    <span>{t.initial}</span>
                  </div>
                </div>

                {/* text */}
                <p className="Tm-Applica-gt-text">{t.text}</p>

                {/* name & role */}
                <h3 className="Tm-Applica-gt-name">{t.name}</h3>
                <p className="Tm-Applica-gt-role">{t.role}</p>

                {/* stars */}
                <div className="Tm-Applica-gt-stars">
                ...
                {/* bottom quote */}
                <span className="Tm-Applica-gt-quote Tm-Applica-gt-quote-bottom">”</span>
              </article>
            ))}
          </div>
          ...
          {/* Right arrow */}
          <button
            className="Tm-Applica-gt-side-arrow Tm-Applica-gt-right"
