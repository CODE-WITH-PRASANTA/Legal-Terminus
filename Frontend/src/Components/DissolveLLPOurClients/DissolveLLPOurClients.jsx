...
import "./DissolveLLPOurClients.css";
...
const DissolveLLPOurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".Dissllp-our-clients-card");
  ...
  return (
    <section className="Dissllp-our-clients-root">
      <div className="Dissllp-our-clients-container">
        <h2 className="Dissllp-our-clients-title">OUR CLIENTS</h2>

        <div className="Dissllp-our-clients-carousel">
          <button
            className="Dissllp-our-clients-arrow Dissllp-our-clients-arrow-left"
            onClick={() => scrollByCard("left")}
          >
            ❮
          </button>

          <div className="Dissllp-our-clients-scroller">
            <ul
              className="Dissllp-our-clients-track"
              ref={trackRef}
            >
              {logosDup.map((src, i) => (
                <li
                  className="Dissllp-our-clients-card"
                  key={i}
                >
                  <figure className="Dissllp-our-clients-logo">
                    <img
                      src={src}
                      alt={`client-${i}`}
                      className="Dissllp-our-clients-img"
                    />
                  </figure>
                </li>
              ))}
          ...
          <button
            className="Dissllp-our-clients-arrow Dissllp-our-clients-arrow-right"
...
export default DissolveLLPOurClients;
