...
import "./ProFPLCTypes.css";
import typesIllustration from "../../assets/pvtltd-types.png";

const PvtTypes = () => {
  return (
    <section className="profplc-types-section">
      <div className="profplc-types-container">
        {/* Left graphic */}
        <div className="profplc-types-illustration-wrap">
          <img
            src={typesIllustration}
            alt="Types of Private Limited Company"
            className="profplc-types-illustration"
          />
        </div>

        {/* Right content */}
        <div className="profplc-types-content">
          <h2 className="profplc-types-title">
            Types of Private Limited Company Registration
          </h2>

          <p className="profplc-types-intro">
          ...
          {/* Type 1 */}
          <div className="profplc-types-block">
            <h3 className="profplc-types-subtitle">Company limited by Shares</h3>
            <p className="profplc-types-text">
          ...
          {/* Type 2 */}
          <div className="profplc-types-block">
            <h3 className="profplc-types-subtitle">Company limited by Guarantee</h3>
            <p className="profplc-types-text">
          ...
          {/* Type 3 */}
          <div className="profplc-types-block">
            <h3 className="profplc-types-subtitle">Unlimited Companies</h3>
            <p className="profplc-types-text">
