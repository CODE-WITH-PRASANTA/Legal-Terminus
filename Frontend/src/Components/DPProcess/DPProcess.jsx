...
const DPProcess = () => {
  return (
    <section className="DP-process-section">
      <h2 className="DP-process-title">
        Steps for societyoration Company Registration in India
      </h2>

      <p className="DP-process-subtitle">
      ...
      <div className="DP-timeline">
        ...
        {steps.map((step, index) => (
          <div
            key={index}
            className={`DP-timeline-item ${
              index % 2 === 0 ? "left" : "right"
            }`}
          >
            <div className="DP-timeline-dot">{index + 1}</div>
