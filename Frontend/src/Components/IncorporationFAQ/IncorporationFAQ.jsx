    ...
    <section className="Incorporation-faq-section">
      <div className="Incorporation-faq-container">
        ...
        <div className="Incorporation-faq-left">
          <h2 className="Incorporation-faq-title">Incorporation Of Wholly Owned Subsidiary in India FAQ&apos;s</h2>
          ...
          <div className="Incorporation-faq-list">
            {faqs.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`Incorporation-faq-item ${isActive ? "active" : ""}`}
                >
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className={`Incorporation-faq-icon ${isActive ? "open" : ""}`}>
                      ▾
                    </span>
                  </button>
                  {isActive && (
                   <div className={`Incorporation-faq-answer ${isActive ? "open" : ""}`}>
                    <p>{item.answer}</p>
                  </div>
