...
const GSTProcess = () => {
  return (
    <section className="cicc-gst-wrapper">
      ...
      <div className="cicc-timeline">
        <div className="cicc-timeline-line" />

        {steps.map((step, index) => (
          <div
            key={index}
            className={`cicc-timeline-item ${
              index % 2 === 0 ? "left" : "right"
            }`}
          >
            <div className="cicc-timeline-dot">{index + 1}</div>

            <div className="cicc-timeline-card">
              <h4>{step.title}</h4>
              <p>{step.text}</p>
            </div>
          </div>
