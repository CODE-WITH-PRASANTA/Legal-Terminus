...
import "./CIOtermconditions.css";

const TermsConditions = () => {
  return (
    <section className="cio-tc-section">
      <div className="cio-tc-container">
        {/* Heading */}
        <h2 className="cio-tc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="cio-tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="cio-tc-list">
          <li className="cio-tc-item">
