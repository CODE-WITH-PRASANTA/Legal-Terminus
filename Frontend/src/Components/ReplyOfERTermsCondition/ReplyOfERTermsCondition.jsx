...
import "./ReplyOfERTermsCondition.css";

const TermsConditions = () => {
  return (
    <section className="Replyof-ER-tc-section">
      <div className="Replyof-ER-tc-container">
        {/* Heading */}
        <h2 className="Replyof-ER-tc-title">TERMS &amp; CONDITIONS</h2>
