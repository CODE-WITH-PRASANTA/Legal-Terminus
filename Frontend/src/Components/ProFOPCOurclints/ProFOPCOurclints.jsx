...
const OurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".ProFOPC-ProFOPC-clients-card");
  ...
  return (
    <section className="ProFOPC-clients-root">
      <div className="ProFOPC-clients-container">
        <h2 className="ProFOPC-clients-title">OUR CLIENTS</h2>

        <div className="ProFOPC-clients-carousel">
          <button className="ProFOPC-clients-arrow ProFOPC-clients-arrow-left"
          ...
          <div className="ProFOPC-clients-scroller">
            <ul className="ProFOPC-clients-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="ProFOPC-clients-card" key={i}>
                  <figure className="ProFOPC-clients-logo">
                    <img src={src} alt={`client-${i}`} className="ProFOPC-clients-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="ProFOPC-clients-arrow ProFOPC-clients-arrow-right"
