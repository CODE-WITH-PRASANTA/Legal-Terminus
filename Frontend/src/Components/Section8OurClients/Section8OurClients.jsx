...
const Section8OurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".section8-our-clients-card");
  ...
  return (
    <section className="section8-our-clients-root">
      <div className="section8-our-clients-container">
        <h2 className="section8-our-clients-title">OUR CLIENTS</h2>

        <div className="section8-our-clients-carousel">
          <button
            className="section8-our-clients-arrow section8-our-clients-arrow-left"
            onClick={() => scrollByCard("left")}
          >
            ❮
          </button>

          <div className="section8-our-clients-scroller">
            <ul
              className="section8-our-clients-track"
              ref={trackRef}
            >
              {logosDup.map((src, i) => (
                <li
                  className="section8-our-clients-card"
                  key={i}
                >
                  <figure className="section8-our-clients-logo">
                    <img
                      src={src}
                      alt={`client-${i}`}
                      className="section8-our-clients-img"
                    />
                  </figure>
                </li>
              ))}
          ...
          <button
            className="section8-our-clients-arrow section8-our-clients-arrow-right"
...
export default Section8OurClients;
