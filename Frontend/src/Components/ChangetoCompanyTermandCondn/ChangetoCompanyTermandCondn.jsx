...
import "./ChangetoCompanyTermandCondn.css";

const TermsConditions = () => {
  return (
    <section className="prp-tc-section">
      <div className="prp-tc-container">
        {/* Heading */}
        <h2 className="prp-tc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="prp-tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="prp-tc-list">
          <li className="prp-tc-item">
