...
import "./DPTermsCondition.css";

const DPTermsCondition = () => {
  return (
    <section className="DP-tc-section">
      <div className="DP-tc-container">

        {/* ================= HEADING ================= */}
        <h2 className="DP-tc-title">TERMS &amp; CONDITIONS</h2>

        {/* ================= SUBTITLE ================= */}
        <p className="DP-tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* ================= LIST ================= */}
        <ol className="DP-tc-list">
          <li className="DP-tc-item">
...
export default DPTermsCondition;
