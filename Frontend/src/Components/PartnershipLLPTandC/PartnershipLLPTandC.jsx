...
import "./PartnershipLLPTandC.css";

const PartnershipLLPTandC = () => {
  return (
    <section className="partnership-llp-tc-section">
      <div className="partnership-llp-tc-container">
        {/* Heading */}
        <h2 className="partnership-llp-tc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="partnership-llp-tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="partnership-llp-tc-list">
          <li className="partnership-llp-tc-item">
...
export default PartnershipLLPTandC;
