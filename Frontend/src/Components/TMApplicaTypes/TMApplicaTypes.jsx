      ...
      <div className="Tm-Application-types-container">
        ...
        <div className="Tm-Application-types-content">
          ...
          <div className="Tm-Application-types-block">
            <h3 className="Tm-Application-types-subtitle">Company limited by Shares</h3>
          ...
          {/* Type 2 */}
          <div className="Tm-Application-types-block">
            <h3 className="Tm-Application-types-subtitle">Company limited by Guarantee</h3>
            <p className="Tm-Application-types-text">
          ...
          {/* Type 3 */}
          <div className="Tm-Application-types-block">
            <h3 className="Tm-Application-types-subtitle">Unlimited Companies</h3>
            <p className="Tm-Application-types-text">
