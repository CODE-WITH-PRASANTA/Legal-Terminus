...
const TermsConditions = () => {
  return (
    <section className="PLC-to-LLP-tc-section">
      <div className="PLC-to-LLP-tc-container">
        {/* Heading */}
        <h2 className="PLC-to-LLP-tc-title">TERMS &amp; CONDITIONS</h2>

        {/* Sub heading */}
        <p className="PLC-to-LLP-tc-subtitle">
          By subscribing to the above plans, you agree to abide by our following
          additional terms and conditions
        </p>

        {/* List */}
        <ol className="PLC-to-LLP-tc-list">
          <li className="PLC-to-LLP-tc-item">
